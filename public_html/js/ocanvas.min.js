...
(function(a, b, c) {
    ...
    d.core.prototype = {
            ...
            b.prototype = a;
            return new b
        }), typeof Object.getPropertyDescriptor != "function" && (Object.getPropertyDescriptor = function(a, b) {
            var d = Object.getOwnPropertyDescriptor(a, b),
                e = Object.getPrototypeOf(a);
            while (d === c && e !== null) d = Object.getOwnPropertyDescriptor(e, b), e = Object.getPrototypeOf(e);
            return d
        }),
        function() {
            var b = 0,
    ...
    var g = function() {
        return {
            ...
            bindHandlers: function() {
                ...
                for (g in this.types) {
                    d.addDOMEventHandler(e, f, g, function(a) {
                        c.canvasHandler(a)
                    }, !1), g === "mousemove" && (g = "mouseover"), d.addDOMEventHandler(e, b, g, function(a) {
                        c.docHandler(a)
                    }, !1);
                    var h = b.createElement("a");
                    h.href = b.referrer, h.host === a.location.host && a.parent !== a && d.addDOMEventHandler(e, a.parent.document, g, function(a) {
                        c.docHandler(a)
                    }, !1)
                }
            },
    ...
    var j = function() {
        return {
            ...
            triggerHandlers: function(a, b, c) {
                var d, e, f, g, h, i, j, k = a === this.core.canvasElement ? this.core : a;
                for (d = 0; d < b.length; d++) {
                    ...
                    if (e) {
                        h = e.length;
                        for (i = 0; i < h; i++) typeof e[i] == "function" && e[i].call(k, j);
            ...
            fixEventObject: function(a, b) {
                ...
                f = {
                    ...
                    stopPropagation: function() {
                        this.bubbles && (this.stoppingPropagation = !0), a !== c && a.stopPropagation()
                    }
                };
                if (a === c) return f;
    ...
    var m = function() {
        return {
            ...
            load: function(a, b) {
                b === !0 && this.current !== "none" && this.unload(this.current), this.current = a, this.scenes[a].load(), this.core.draw.redraw();
                return this
            },
            unload: function(a) {
                this.current = "none", this.scenes[a].unload(), this.core.draw.redraw();
                return this
            }
        }
    };
    ...
    var o = function() {
        var a = {
            ...
            parseEasingOption: function(a) {
                return typeof a == "string" ? ~a.indexOf("cubic-bezier") ? this.getCustomCubicBezier(a) || this.easing[this.defaults.easing] : this.easing[a] || this.easing[this.defaults.easing] : typeof a == "function" ? a : this.easing[this.defaults.easing]
            },
                ...
                create: function(b, d) {
                    d === c && (d = Math.round((new Date).getTime() * Math.random()) + ""), b.animationQueues[d] || (b.animationQueues[d] = {
                        ...
                        clear: function(b) {
                            if (this.isRunning) {
                                var c = this.list[0];
                                c.cancelled = !0, b && (a.setEndValues(c), c.options.callback.call(c.obj)), this.isRunning = !1, a.mainTimer.remove(c)
                            }
                            this.list.length = 0
                        }
                    });
            ...
            easing: {
                ...
                "ease-in-out-elastic": function(a, b, c, d, e, f) {
                    ...
                    if (a < 1) return -0.5 * e * Math.pow(2, 10 * (a -= 1)) * Math.sin((a * d - g) * 2 * Math.PI / f) + b;
                ...
                "ease-in-out-bounce": function(a, b, c, d) {
                    ...
                    return this["ease-out-bounce"](a * 2 - d, 0, c, d) * .5 + c * .5 + b
                },
            ...
            return {
                ...
                clone: function(a) {
                    ...
                    var b = this.parent,
                        ...
                        f = {},
                        g = ["core", "events", "children", "parent", "img", "fill", "strokeColor", "added"],
                    ...
                    j = function(a, d) {
                        for (k in a) {
                            ...
                            if (r && r.get === c) {
                                ...
                                var e = a[k];
                                b && (h.indexOf(k) > -1 ? e -= b.abs_x : i.indexOf(k) > -1 && (e -= b.abs_y)), d[k] = e
                            }
                        }
                    }, j(this, f), f.fill = this._.fill, l = this.core.style.getStroke(this.stroke), f.strokeColor = l.color, e = d.extend(e, f, a), e.id = ++this.core.lastObjectID, typeof e.init == "function" && e.init(), n = this.children;
                    if (n.length > 0)
                        for (m = 0; m < n.length; m++) o = n[m].clone(), e.children.push(o), o.parent = e, a.x && (p = Math.abs(n[m].abs_x - this.x), o.x = p), a.y && (q = Math.abs(n[m].abs_y - this.y), o.y = q);
                    return e
                },
    ...
    var s = function(a, b) {
        return d.extend({
            ...
            init: function() {
                var a = this,
                    b;
                this.image !== c && (this.img = new Image, this.img.onload = function() {
                    a.loaded = !0, a.width !== 0 ? a.height === 0 && (a.height = a.width / (this.width / this.height)) : a.width = this.width, a.height !== 0 ? a.width === 0 && (a.width = a.height / (this.height / this.width)) : a.height = this.height, a.tile_width = a.tile_width === 0 ? a.width : a.tile_width, a.tile_height = a.tile_height === 0 ? a.height : a.tile_height, a._.hasBeenDrawn && a.core.redraw()
            ...
            draw: function() {
                ...
                this.clipChildren && (a.beginPath(), a.rect(e, f, g, h), a.closePath(), a.clip()), this._.hasBeenDrawn = !0;
                return this
            }
        }, a)
    };
        ...
        u = function(a, c) {
            ...
            return d.extend({
                ...
                initWebFont: function() {
                    var a = this.style + " " + this.variant + " " + this.weight + " 0px " + this.family;
                    if (!(t.indexOf(a) > -1)) {
                        t.push(a);
                        var c = this,
                            d = this.core,
                            e;
                        e = b.createElement("span"), e.style.font = a, b.body.appendChild(e), setTimeout(function() {
        ...
        return d.extend({
            ...
            draw: function() {
                var a = this.core.canvas,
                    ...
                    c = this.abs_x - b.x,
                    d = this.abs_y - b.y;
                a.beginPath(), this.radius > 0 && this.start !== this.end && (this.pieSection && a.moveTo(c, d), a.arc(c, d, this.radius, this.start * Math.PI / 180, this.end * Math.PI / 180, this.direction === "anticlockwise"), this.fill !== "" && (a.fillStyle = this.fill, a.fill()), this.strokeWidth > 0 && (a.lineWidth = this.strokeWidth, a.strokeStyle = this.strokeColor, a.stroke())), a.closePath(), this.clipChildren && a.clip();
                return this
            }
        }, a)
    };
    ...
    var w = function(a, b) {
        return d.extend({
            ...
            draw: function() {
                ...
                this.fill !== "" && (a.fillStyle = this.fill, a.fill()), this.strokeWidth > 0 && (a.lineWidth = this.strokeWidth, a.strokeStyle = this.strokeColor, a.stroke()), a.closePath(), this.clipChildren && a.clip();
                return this
            }
        }, a)
    };
    ...
    var x = function(a, b) {
        return d.extend({
            ...
            draw: function() {
                ...
                a.closePath(), this.fill !== "" && (a.fillStyle = this.fill, a.fill()), this.strokeWidth > 0 && (a.lineWidth = this.strokeWidth, a.strokeStyle = this.strokeColor, a.stroke()), this.clipChildren && a.clip();
                return this
            }
        }, a)
    };
    ...
    var y = function(a, b) {
        return d.extend({
            ...
            set length(a) {
                var b, c, d, e;
                b = Math.abs(this._.end_x - this._.start_x), c = Math.abs(this._.end_y - this._.start_y), d = Math.sqrt(b * b + c * c), e = Math.asin(b / d), b = Math.sin(e) * a, c = Math.cos(e) * a, this._.end_x = this._.start_x + b, this._.end_y = this._.start_y + c, this.x += 0, this.y += 0, this.setPosition()
            },
            get length() {
                var a, b, c;
    ...
    var z = function(a, b) {
        return d.extend({
            ...
            draw: function() {
                ...
                if (this.loaded) {
                    if (this.frames.length > 0) {
                        if (this.frame > this.frames.length) {
                            this.clipChildren && (b.beginPath(), b.rect(e, f, 0, 0), b.closePath(), b.clip());
                            return this
                        }
                        g = this.frames[this.frame - 1], h = g.w !== c ? g.w : this.width, i = g.h !== c ? g.h : this.height, b.drawImage(this.img, g.x, g.y, h, i, e, f, h, i), this.strokeWidth > 0 && (b.lineWidth = this.strokeWidth, b.strokeStyle = this.strokeColor, b.strokeRect(e, f, h, i)), this.running === !1 && this.active && (setTimeout(function() {
                ...
                this.clipChildren && (b.beginPath(), b.rect(e, f, h, i), b.closePath(), b.clip());
                return this
            },
            start: function() {
                this.startAnimation();
